...
namespace UI.UrunServiceReference {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="UrunDTO", Namespace="http://schemas.datacontract.org/2004/07/DTO")]
    ...
    public interface IServiceOf_UrunDTO {
        ...
        System.Collections.Generic.List<UI.UrunServiceReference.UrunDTO> Listele();
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceOf_UrunDTO/Listele", ReplyAction="http://tempuri.org/IServiceOf_UrunDTO/ListeleResponse")]
        System.Threading.Tasks.Task<System.Collections.Generic.List<UI.UrunServiceReference.UrunDTO>> ListeleAsync();
        ...
        bool Ekle(UI.UrunServiceReference.UrunDTO dto);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceOf_UrunDTO/Ekle", ReplyAction="http://tempuri.org/IServiceOf_UrunDTO/EkleResponse")]
        System.Threading.Tasks.Task<bool> EkleAsync(UI.UrunServiceReference.UrunDTO dto);
        ...
        bool Guncelle(UI.UrunServiceReference.UrunDTO dto);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceOf_UrunDTO/Guncelle", ReplyAction="http://tempuri.org/IServiceOf_UrunDTO/GuncelleResponse")]
        System.Threading.Tasks.Task<bool> GuncelleAsync(UI.UrunServiceReference.UrunDTO dto);
        ...
        bool Sil(UI.UrunServiceReference.UrunDTO dto);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IServiceOf_UrunDTO/Sil", ReplyAction="http://tempuri.org/IServiceOf_UrunDTO/SilResponse")]
        System.Threading.Tasks.Task<bool> SilAsync(UI.UrunServiceReference.UrunDTO dto);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface IServiceOf_UrunDTOChannel : UI.UrunServiceReference.IServiceOf_UrunDTO, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class ServiceOf_UrunDTOClient : System.ServiceModel.ClientBase<UI.UrunServiceReference.IServiceOf_UrunDTO>, UI.UrunServiceReference.IServiceOf_UrunDTO {
        ...
        public System.Collections.Generic.List<UI.UrunServiceReference.UrunDTO> Listele() {
            return base.Channel.Listele();
        }
        
        public System.Threading.Tasks.Task<System.Collections.Generic.List<UI.UrunServiceReference.UrunDTO>> ListeleAsync() {
            return base.Channel.ListeleAsync();
        }
        
        public bool Ekle(UI.UrunServiceReference.UrunDTO dto) {
            return base.Channel.Ekle(dto);
        }
        
        public System.Threading.Tasks.Task<bool> EkleAsync(UI.UrunServiceReference.UrunDTO dto) {
            return base.Channel.EkleAsync(dto);
        }
        
        public bool Guncelle(UI.UrunServiceReference.UrunDTO dto) {
            return base.Channel.Guncelle(dto);
        }
        
        public System.Threading.Tasks.Task<bool> GuncelleAsync(UI.UrunServiceReference.UrunDTO dto) {
            return base.Channel.GuncelleAsync(dto);
        }
        
        public bool Sil(UI.UrunServiceReference.UrunDTO dto) {
            return base.Channel.Sil(dto);
        }
        
        public System.Threading.Tasks.Task<bool> SilAsync(UI.UrunServiceReference.UrunDTO dto) {
